  ...
  describe('Adapter Base Class Tests', () => {
    ...
    describe('#getAllFunctions', () => {
      ...
      it('should return a list of functions', (done) => {
        const returnedFunctions = ['addEntityCache', 'capabilityResults', 'checkActionFiles', 'checkProperties', 'connect', 'encryptProperty', 'entityInList', 'getAllCapabilities', 'getAllFunctions', 'getQueue', 'getWorkflowFunctions', 'healthCheck', 'refreshProperties', 'updateAdapterConfiguration', 'addListener', 'emit', 'eventNames', 'getMaxListeners', 'listenerCount', 'listeners', 'off', 'on', 'once', 'prependListener', 'prependOnceListener', 'rawListeners', 'removeAllListeners', 'removeListener', 'setMaxListeners'];
        try {
    ...
    describe('#getAllCapabilities', () => {
      ...
      it('should have have capabilities returned', (done) => {
        try {
